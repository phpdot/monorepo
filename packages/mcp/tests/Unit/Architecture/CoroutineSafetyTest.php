...
namespace PHPdot\Mcp\Tests\Unit\Architecture;
 ...
 * mutable instance state that exists (the per-worker discovery memo) lives
 * behind a class the container builds once per worker.
 */
final class CoroutineSafetyTest extends TestCase
{
    ...
    public static function srcClasses(): iterable
    {
        ...
        foreach ($iterator as $file) {
            ...
            $class = 'PHPdot\\Mcp\\' . str_replace('/', '\\', $relative);
