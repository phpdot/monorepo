...
final class Psr3Writer implements WriterInterface
{
    ...
    /**
     * Create the bridge forwarding records to a PSR-3 logger.
     *
     ...
     *
     * A secure() record is encrypted, or fail-closed (dropped, never
     * plaintext) when no encryptor is configured. A logger failure never
     * crashes the caller — the record is dropped instead.
     *
