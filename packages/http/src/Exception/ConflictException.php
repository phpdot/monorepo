 ...
 * ConflictException
 *
 * Thrown when the request conflicts with the current state of the target resource.
 *
...
{
    /**
     * Create a new Conflict (409) exception.
     *
    ...
    public function __construct(
        ...
        parent::__construct(409, $message, $detail, $type, $instance, $extensions, $previous);
    }
}
