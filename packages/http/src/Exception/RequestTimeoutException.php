 ...
 *
 * Thrown when the server timed out waiting for the request.
 *
...
{
    /**
     * Create a new Request Timeout (408) exception.
     *
    ...
    public function __construct(
        ...
        parent::__construct(408, $message, $detail, $type, $instance, $extensions, $previous);
    }
}
