 ...
 *
 * Thrown when the server encountered an unexpected condition that prevented it from fulfilling the request.
 *
...
{
    /**
     * Create a new Internal Server Error (500) exception.
     *
    ...
    public function __construct(
        ...
        parent::__construct(500, $message, $detail, $type, $instance, $extensions, $previous);
    }
}
