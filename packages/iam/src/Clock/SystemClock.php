 ...
 *
 * Bound as the default `ClockInterface` via `#[Binds]`, so the
 * `AuthenticationEngine` resolves out of the box in a phpdot/container app;
 * override the binding to supply your own clock.
 *
 * @author Omar Hamdan <omar@phpdot.com>
 * @license MIT
 */

namespace PHPdot\Iam\Clock;
