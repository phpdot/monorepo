...
/**
 * The answer to a PoliciesFilterDTO: the matched policies and the slice they
 * came from.
 *
...
final readonly class PoliciesSearchDTO implements SearchDTO
{
    /**
     * @param Paginator<PolicyEntityDTO> $page The matched slice, and the counts describing it
