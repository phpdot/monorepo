...
/**
 * The answer to a PermissionsFilterDTO: the matched permissions and the
...
final readonly class PermissionsSearchDTO implements SearchDTO
{
    /**
     * @param Paginator<PermissionEntityDTO> $page The matched slice, and the counts describing it
